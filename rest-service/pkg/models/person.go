...
var people = []*Person{
	{
		ID:          uuid.Must(uuid.Parse("81eb745b-3aae-400b-959f-748fcafafd81")),
		FirstName:   "John",
		LastName:    "Doe",
		PhoneNumber: "+1 (800) 555-1212",
	},
	{
		ID:          uuid.Must(uuid.Parse("5b81b629-9026-450d-8e46-da4f8c7bd513")),
		FirstName:   "Jane",
		LastName:    "Doe",
		PhoneNumber: "+1 (800) 555-1313",
	},
	{
		ID:          uuid.Must(uuid.Parse("df12ce76-767b-4bf0-bccb-816745df9e70")),
		FirstName:   "Brian",
		LastName:    "Smith",
	...
	{
		ID:          uuid.Must(uuid.Parse("135af595-aa86-4bb5-a8f7-df17e6148e63")),
		FirstName:   "John",
		LastName:    "Doe",
	...
	{
		ID:          uuid.Must(uuid.Parse("000ebe58-b659-422b-ab48-a0d0d40bd8f9")),
		FirstName:   "Jenny",
		LastName:    "Smith",
		PhoneNumber: "+44 7700 900077",
	},
